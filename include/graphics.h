...
extern const u32 gMonPalette_Vill[];
extern const u32 gMonBackPic_Vill[];
extern const u8 gMonIcon_Vill[];
extern const u8 gMonFootprint_Vill[];
extern const u32 gMonFrontPic_Gilan[];
extern const u32 gMonPalette_Gilan[];
extern const u8 gMonIcon_Gilan[];
extern const u8 gMonFootprint_Gilan[];
...
extern const u32 gMonPalette_Everest[];
...
extern const u8 gMonIcon_Chimecho[];
extern const u8 gMonIcon_Vill[];
extern const u8 gMonIcon_Marie[];
extern const u8 gMonIcon_Gilan[];
extern const u8 gMonIcon_Everest[];
extern const u8 gMonIcon_Egg[];
