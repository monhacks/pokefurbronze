const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_VILL] = sGlaceonLevelUpLearnset,
    [SPECIES_MARIE] = sEeveeLevelUpLearnset,
    [SPECIES_MARIEF] = sFlareonLevelUpLearnset,
    [SPECIES_GILAN] = sEeveeLevelUpLearnset,
    [SPECIES_GILANG] = sGlaceonLevelUpLearnset,
    [SPECIES_EVEREST] = sEeveeLevelUpLearnset,
    [SPECIES_EVERESTL] = sLeafeonLevelUpLearnset,
