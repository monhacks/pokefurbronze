const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MARIE]     = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
							{EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
							{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_LEVEL, 20, SPECIES_MARIEF},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON}},
	[SPECIES_GILAN]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_LEVEL, 20, SPECIES_GILANG},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON}},
	[SPECIES_EVEREST]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_LEVEL, 20, SPECIES_EVERESTL},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON}},
};
