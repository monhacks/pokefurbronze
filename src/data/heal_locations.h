...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_KAILO_TOWN - 1] = {MAP_GROUP(KAILO_TOWN_POKEMON_CENTER_1F), MAP_NUM(KAILO_TOWN_POKEMON_CENTER_1F)},
    [SPAWN_HOME - 1] = {MAP_GROUP(KAILO_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(KAILO_TOWN_PLAYERS_HOUSE_2F)},
};
