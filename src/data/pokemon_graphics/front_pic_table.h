const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(VILL, gMonFrontPic_Vill),
    SPECIES_SPRITE(MARIE, gMonFrontPic_Eevee),
    SPECIES_SPRITE(MARIEF, gMonFrontPic_Flareon),
    SPECIES_SPRITE(GILAN, gMonFrontPic_Gilan),
    SPECIES_SPRITE(GILANG, gMonFrontPic_Glaceon),
    SPECIES_SPRITE(EVEREST, gMonFrontPic_Everest),
    SPECIES_SPRITE(EVERESTL, gMonFrontPic_Leafeon),
