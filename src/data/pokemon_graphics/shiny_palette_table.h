const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(VILL, gMonPalette_Vill),
    SPECIES_SHINY_PAL(MARIE, gMonPalette_Eevee),
    SPECIES_SHINY_PAL(MARIEF, gMonPalette_Flareon),
    SPECIES_SHINY_PAL(GILAN, gMonPalette_Gilan),
    SPECIES_SHINY_PAL(GILANG, gMonPalette_Glaceon),
    SPECIES_SHINY_PAL(EVEREST, gMonPalette_Everest),
    SPECIES_SHINY_PAL(EVERESTL, gMonPalette_Leafeon),
