const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(VILL, gMonBackPic_Vill),
    SPECIES_SPRITE(MARIE, gMonBackPic_Eevee),
    SPECIES_SPRITE(MARIEF, gMonBackPic_Flareon),
    SPECIES_SPRITE(GILAN, gMonBackPic_Eevee),
    SPECIES_SPRITE(GILANG, gMonBackPic_Glaceon),
    SPECIES_SPRITE(EVEREST, gMonBackPic_Eevee),
    SPECIES_SPRITE(EVERESTL, gMonBackPic_Leafeon),
