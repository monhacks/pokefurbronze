...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_VILL]        = gMonIcon_Vill,
    [SPECIES_MARIE]       = gMonIcon_Eevee,
    [SPECIES_MARIEF]      = gMonIcon_Flareon,
    [SPECIES_GILAN]       = gMonIcon_Eevee,
    [SPECIES_GILANG]      = gMonIcon_Glaceon,
    [SPECIES_EVEREST]     = gMonIcon_Eevee,
    [SPECIES_EVERESTL]    = gMonIcon_Leafeon,
