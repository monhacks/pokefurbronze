...
#define OBJ_EVENT_PAL_EEVEE                           0x111C
#define OBJ_EVENT_PAL_GLACEON                         0x111D
...
static const struct SpritePalette sObjectEventSpritePalettes[] = {
    ...
    {gObjectEventPalette_Eevee,               OBJ_EVENT_PAL_EEVEE},
    {gObjectEventPalette_Glaceon,             OBJ_EVENT_PAL_GLACEON},
    {},
};
